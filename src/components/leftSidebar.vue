            ...
            <el-scrollbar style="height:100%;width:100%;">
              <div class="alaa">
                ...
                <el-submenu index="1">
                  ...
                  <el-menu-item-group>
                    <template slot="title">视频类</template>
                    <el-menu-item index="1-1">全网视频</el-menu-item>
                    <el-menu-item index="1-2">视频解析</el-menu-item>
                    <el-menu-item index="1-3">视频</el-menu-item>
                  </el-menu-item-group>
                  <el-menu-item-group title="音乐类">
                    <el-menu-item index="1-4">全网音乐</el-menu-item>
                    <el-menu-item index="1-5">音乐解析</el-menu-item>
                    <el-menu-item index="1-6">音乐下载</el-menu-item>
                  </el-menu-item-group>
